...
El resultado más significativo es cualitativo: exponer y editar una entidad nueva
...
LOC mínimas para exponer una entidad nueva (backend) & $\approx$\,35 \\ \hline
LOC de frontend para una entidad nueva & 0 \\ \hline
\end{tabular}
\end{table}
...
La tabla~\ref{tab:recursos} recoge el consumo de recursos del stack en reposo,
medido con \texttt{docker stats} sobre la máquina de desarrollo con el sistema
completo arrancado y sin carga activa.

\begin{table}[!htbp]
\caption{Consumo de memoria del stack Docker en reposo.}
\label{tab:recursos}
\centering
\begin{tabular}{|p{5.5cm}|r|}
\hline
\textbf{Contenedor} & \textbf{Memoria} \\ \hline
\texttt{uniback\_assistant} & 213{,}5 MiB \\ \hline
\texttt{uniback\_web} & 190{,}1 MiB \\ \hline
\texttt{uniback\_files} & 145{,}4 MiB \\ \hline
\texttt{uniback\_auth} & 138{,}7 MiB \\ \hline
\texttt{uniback\_annotations} & 138{,}1 MiB \\ \hline
\texttt{uniback\_species} & 137{,}8 MiB \\ \hline
\texttt{traefik} & 104{,}9 MiB \\ \hline
\texttt{ub\_pg} (PostgreSQL) & 72{,}5 MiB \\ \hline
\texttt{redis} & 33{,}0 MiB \\ \hline
\texttt{celery\_worker} & 2{,}4 MiB \\ \hline
\textbf{Total} & \textbf{$\approx$\,1{,}18 GiB} \\ \hline
\end{tabular}
\end{table}
