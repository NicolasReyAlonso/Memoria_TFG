...
los componentes conocían de forma explicita la forma de los datos y los
...
de un nuevo proyecto con el \gls{jardincanario} manifestó la utilizad de un proyecto
de este tipo.
...
punto intermedio, ya que priorizé entregar la librería \gls{ngtgl} funcional. Así, el
...
backend, que no se había abstraido, funcionaba como un backend tradicional: 
...
En resumen, el framework no estaba terminado y, a escepción del frontend,
...
completar, optimizar y cerrar tanto el backend como el frontend, y de unirlos mediante un contrato que los desacople del dominio.
